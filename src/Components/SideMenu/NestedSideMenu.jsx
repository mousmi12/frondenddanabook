                                                ...
                                                if (isSeparator) {
                                                    ...
                                                    return (
                                                        <div className='flex flex-col items-center justify-center mt-2' key={submenu.id} onMouseLeave={() => handleSubmenuClick(null)}>
                                                            ...
                                                            {submenu.label && (
                                                                <label className='font-bold text-center' style={{ fontSize: '9px', color: (darkModeState.checkvalue ? dayTheme.menuLabelColor : darkTheme.menuLabelColor) }}>{submenu.label.toUpperCase()}</label>
                                                            )}
